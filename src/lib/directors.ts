...
export const DIRECTORS = [
  { name: "Dicky Lewis",   email: "dicky.lewis@white-red.co.uk"   },
  { name: "Joe Haire",     email: "joe.haire@white-red.co.uk"     },
  { name: "Jesus Jimenez", email: "jesus.jimenez@white-red.co.uk" },
];
