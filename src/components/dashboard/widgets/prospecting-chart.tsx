      ...
      <CardContent className="pb-4">
        {disableAnimations ? (
          ...
          >
             ...
             */}
            <Bar dataKey="New Lead"              stackId="a" fill="#FBBF24" radius={[0, 0, 4, 4]} name="New Lead" isAnimationActive={false} />
            <Bar dataKey="Attempted to Contact"  stackId="a" fill="#FBCFE8" name="Attempted to Contact" isAnimationActive={false} />
            <Bar dataKey="Needs Follow up"       stackId="a" fill="#F97316" name="Needs Follow up" isAnimationActive={false} />
          ...
          <ResponsiveContainer width="100%" height={chartHeight}>
            ...
            >
               ...
               * (New Lead at the bottom, Appointments at the top).
               */}
              <Bar dataKey="New Lead"              stackId="a" fill="#FBBF24" radius={[0, 0, 4, 4]} name="New Lead" isAnimationActive={true} />
              <Bar dataKey="Attempted to Contact"  stackId="a" fill="#FBCFE8" name="Attempted to Contact" isAnimationActive={true} />
              <Bar dataKey="Needs Follow up"       stackId="a" fill="#F97316" name="Needs Follow up" isAnimationActive={true} />
